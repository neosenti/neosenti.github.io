...
export function Contact({ translations }: ContactProps) {
  ...
  return (
    <section id="contact" className="py-24 px-6 bg-gradient-to-br from-slate-800 to-slate-900">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold mb-6 text-white">{translations.contact.title}</h2>
          <p className="text-xl text-slate-300 mb-4">{translations.contact.subtitle}</p>
          <p className="text-slate-400 max-w-2xl mx-auto">{translations.contact.description}</p>
        </div>
          ...
          <div className="lg:col-span-3">
            <Card className="bg-white/5 backdrop-blur-sm border-white/10 shadow-2xl">
              <CardContent className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 needs-validation" noValidate>
                  <input type="hidden" name="access_key" value="db1154ef-e3cf-4bad-ad7a-e9c5d94c55c3" />
            ...
            <Card className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 border-blue-400/20 backdrop-blur-sm">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-white mb-2">
                  {translations.contact.partnerships || "Parcerias & Investimentos"}
                </h3>
